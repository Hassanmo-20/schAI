...
|---|---|---|---|
| Routes | `routes/api.php` | URL → controller only (17 routes) | `POST /tasks/{task}/complete` |
...
66 feature tests under `tests/Feature/` (`php artisan test`, sqlite `:memory:`) covering auth,
